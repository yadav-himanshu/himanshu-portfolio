...
import { experiences } from "@/app/data/ExperienceAndEducation";
    ...
    <div className="w-full relative py-16 text-white">
      <div className="max-w-6xl mx-auto px-6">
        ...
        <div className="relative">
          {/* Mobile: left line; Desktop: centered line */}
          ...
          {experiences.map((exp, i) => (
            ...
            >
              ...
              {/* ICON column:
                  - on mobile it's column 1 (left narrow column),
                  - on desktop it's column 2 (center narrow column)
              */}
              <div className="col-start-1 md:col-start-2 flex justify-center">
                <div className="flex flex-col items-center">
                  {/* date (optional on mobile above icon) */}
                  <span className="hidden md:hidden mb-1 text-xs text-gray-500">
                    {exp.date}
                  </span>
              ...
              {/* MOBILE card (always in the right column on mobile) */}
...
function TimelineCard({ exp, mobile = false }: any) {
  return (
    <div
